...
export const getUserProducts = createAsyncThunk('/user/getUserProducts', async(filters = {}, {rejectWithValue})=>{
    try{
        const queryParams = new URLSearchParams(filters).toString();
        const response = await instance.get(`/user/products?${queryParams}`);
...
export const {clearProducts, setCurrentPage, setFilters} = userProductSlice.actions;
