...
export const addAddress = createAsyncThunk('/address/addAddress', async(formData, {rejectWithValue})=>{
    try{
...
export const getSingleAddress = createAsyncThunk('/address/getSingleAddress', async(id, {rejectWithValue})=>{
    try{
...
export const editAddress = createAsyncThunk('/address/editAddress', async({id, formData}, {rejectWithValue})=>{
    try{
        const response = await instance.patch(`/user/address/edit/${id}`, formData);
        return response.data.address;
    }catch(err){
        return rejectWithValue(err.response.data.errors);
    }
...
export const deleteAddress = createAsyncThunk('/address/deleteAddress', async(id, {rejectWithValue})=>{
    try{
        const response = await instance.delete(`/user/address/delete/${id}`);
        return response.data.address;
    }catch(err){
        return rejectWithValue(err.response.data);
    }
