...
const PaymentSuccess = () => {
    ...
    const title = order?.paymentMethod === "COD" ? "Order Confirmed" : "Payment Successful";
            ...
            <section className='payment-success-section'>
                <Container className='text-center success-content'>
                    ...
                    <motion.div
                        ...
                        <Button variant='outline-dark' className='px-4 py-2' onClick={()=> navigate('/user/product', {replace: true})}>
                            CONTINUE SHOPPING
                        </Button>
                    </motion.div>
                </Container>
