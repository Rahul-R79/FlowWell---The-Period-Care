                    ...
                    <div className='col-xl-9 col-lg-8 col-md-7 col-sm-12 mt-4 mb-5'>
                        <div className='p-4 shadow rounded bg-white'>
                            <div className='d-flex justify-content-between align-items-center mb-4'>
                                <h3 className='mb-0 mx-auto fw-bold'>MY WALLET</h3>
                            </div>
                            ...
                            <div className='bg-light p-4 rounded mb-4'>
                                ...
                                <div className='d-flex gap-2 mb-3'>
                                    <button
                                        className={`btn btn-outline-secondary ${amount === 500 ? 'active' : ''}`}
                                        onClick={() => setAmount(500)}
                                    >
                                        +₹500
                                    </button>
                                    <button
                                        className={`btn btn-outline-secondary ${amount === 1000 ? 'active' : ''}`}
                                        onClick={() => setAmount(1000)}
                                    >
                                        +₹1000
                                    </button>
                                    <button
                                        className={`btn btn-outline-secondary ${amount === 5000 ? 'active' : ''}`}
                                        onClick={() => setAmount(5000)}
                                    >
                                        +₹5000
                                    </button>
                                </div>
                                <Link className='btn btn-dark' to={`/wallet/add?amount=${amount}`}>
                                    Add money to wallet
                                </Link>
                            </div>

                            {/* Transaction History Button */}
                            <Link className='btn btn-primary' to={'/wallet/transactions'}>
