...
function SignIn() {
    ...
    const getFieldError = (fieldName) => {
        return errorByAction.signinUser?.find((e) => e.field === fieldName)
            ?.message;
    };
                            ...
                            <div className='w-100 my-auto'>
                                ...
                                <form noValidate onSubmit={handleSignIn}>
                                    ...
                                    <div className='mb-5 text-end'>
                                        <Link
                                            to='/forgotpassword'
                                            className='text-primary mb-0 small text-decoration-none'>
                                            Forgot Password
                                        </Link>
                                    </div>
                                    {/* Login Button */}
                                    ...
                                    {/* Google Sign-In */}
                                    <div className='text-center text-light mb-3 small'>
                                        Continue with
                                    </div>
                                    <div className='d-grid'>
                                        <button
                                            ...
                                            <img
                                                ...
                                                height='20'
                                            />
                                            <span className='fw-medium google-text'>
                                                Signin with Google
                                            </span>
                                        </button>
                                    </div>
